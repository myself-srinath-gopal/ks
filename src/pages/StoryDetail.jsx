...
import { ArrowLeft, ArrowRight, MapPin, Camera, Calendar, Aperture } from 'lucide-react';
...
const StoryDetail = () => {
    ...
    // Find next story for navigation
            ...
            <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16 items-end">
                    <div className="lg:col-span-8">
                        <motion.span
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            className="block text-xs font-bold tracking-[0.2em] text-gray-400 mb-6 uppercase"
                        >
                            {story.category}
                        </motion.span>
                        <motion.h1
                            ...
                            className="text-5xl md:text-7xl lg:text-8xl font-medium text-gray-900 leading-tight"
                        >
                            {story.title}
                        </motion.h1>
                    </div>
                    ...
                    <div className="lg:col-span-4 text-right lg:text-left">
                        <p className="text-gray-500 font-mono text-sm">{story.date}</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-32">
                    ...
                    <div className="lg:col-span-7">
                        <h3 className="text-3xl font-bold mb-8">The Narrative</h3>
                        <p className="text-gray-600 text-lg md:text-xl leading-relaxed font-light mb-8 drop-cap">
                            {story.description}
                        </p>
                        <p className="text-gray-600 text-lg leading-relaxed font-light">
                            Photography is an act of preservation. In this frame, we sought to capture not just the visual elements, but the feeling of the air, the quality of the silence, and the fleeting nature of the light. It serves as a reminder that every moment holds a story waiting to be told.
                        </p>
                    </div>
                    ...
                    <div className="lg:col-span-4 lg:col-start-9 space-y-10">
                        <div className="border-t border-gray-900 pt-6">
                            <h4 className="text-xl font-bold mb-6">Technical Specs</h4>

                            <div className="space-y-6">
                                <div className="group">
                                    <span className="flex items-center text-xs text-gray-400 uppercase tracking-widest mb-1">
                                        <MapPin size={12} className="mr-2" /> Location
                                    </span>
                                    <span className="text-lg font-medium text-gray-900">{story.location}</span>
                                </div>

                                <div className="group">
                                    <span className="flex items-center text-xs text-gray-400 uppercase tracking-widest mb-1">
                                        <Camera size={12} className="mr-2" /> Gear
                                    </span>
                                    <span className="text-lg font-medium text-gray-900">{story.camera}</span>
                                </div>

                                <div className="group">
                                    <span className="flex items-center text-xs text-gray-400 uppercase tracking-widest mb-1">
                                        <Aperture size={12} className="mr-2" /> Settings (Est.)
                                    </span>
                                    <span className="text-lg font-medium text-gray-900">f/2.8 • 1/200s • ISO 100</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="border-t border-gray-100 pt-20 pb-10">
                    <div className="flex flex-col items-end">
                        <span className="text-xs text-gray-400 uppercase tracking-widest mb-4">Next Story</span>
                        <Link
